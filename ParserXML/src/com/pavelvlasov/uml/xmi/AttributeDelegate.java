 ...
 * @version $Revision$
 */
class AttributeDelegate implements Attribute {
	 ...
	 * 
	 */
	public AttributeDelegate(Attribute master, ModelElement owner) {
		super();
		this.master=master;
		this.owner=owner;
	}
