...
\centering
	...
	\caption{Árvore de Derivação da regra packageDeclaration}
\end{figure}
...
\centering
	...
	\caption{Árvore de Derivação da regra packageDeclarationAux}
\end{figure}
...
\centering
	...
	\caption{Árvore de Derivação da regra bodyDeclaration}
\end{figure}
...
\centering
	...
	\caption{Árvore de Derivação da regra propertyCall}
\end{figure}
