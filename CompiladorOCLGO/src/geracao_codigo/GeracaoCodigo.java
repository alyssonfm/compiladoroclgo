...
// Sun May 29 00:44:15 GMT-03:00 2011
//----------------------------------------------------
...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun May 29 00:44:15 GMT-03:00 2011
  */
...
class CUP$GeracaoCodigo$actions {
  ...
  public final java_cup.runtime.Symbol CUP$GeracaoCodigo$do_action(
	...
	RESULT = val;
              ...
              CUP$GeracaoCodigo$result = parser.getSymbolFactory().newSymbol("propertyCall",25, ((java_cup.runtime.Symbol)CUP$GeracaoCodigo$stack.elementAt(CUP$GeracaoCodigo$top-2)), ((java_cup.runtime.Symbol)CUP$GeracaoCodigo$stack.peek()), RESULT);
            }
          return CUP$GeracaoCodigo$result;
	...
	Gerador.getInstance().gen(TemplateCode.IF(val.getAtributo("code"), val1.getAtributo("code"), val2.getAtributo("code")));  
	...
	if(aux != null){
		...
		val.coercao(auxElem.getAtributo("tipo"));
	}
	RESULT = val;
	...
	Elemento e = (Elemento) v;
	Elemento pa = (Elemento) p;
	Elemento r = new Elemento(e.getAtributo("string"));
	r.setAtributo("code", e.getAtributo("code") + ", " + pa.getAtributo("code"));
	r.setAtributo("string", e.getAtributo("string") + "," + pa.getAtributo("string"));
	RESULT = r; 
	...
	if(ope == null){
		Gerador.getInstance().gen(TemplateCode.FUNCTION(splited[splited.length - 2], splited[splited.length - 1], "", typeElem.getAtributo("code")));
		val.setAtributo("string", id.toString() + pno.toString() + "()" + ":" + typeElem.toString());
	}else{
		Gerador.getInstance().gen(TemplateCode.FUNCTION(splited[splited.length - 2], splited[splited.length - 1], opeElem.getAtributo("code"), typeElem.getAtributo("code")));
		val.setAtributo("string", id.toString() + pno.toString() + "(" + opeElem.getAtributo("string") + ")" + ":" + typeElem.toString());
	}
	RESULT =  val;
