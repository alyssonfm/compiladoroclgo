...
public class AnaliseSintatica extends java_cup.runtime.lr_parser {
	...
	public AnaliseSintatica(java_cup.runtime.Scanner s) {
		super(s);
	}
	...
	/** Production table. */
	protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\147\000\002\002\004\000\002\002\005\000\002\002"
	...
	/** Parse-action table. */
	protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\054\000\012\002\ufffd\004\005\005\010\006\011\001"
	...
	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\054\000\010\002\006\003\003\004\005\001\001\000"
...
class CUP$parser$actions {
	...
	public final java_cup.runtime.Symbol CUP$parser$do_action(
		...
		case 77: // additiveExpression ::=
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 76: // additiveExpression ::= multiplicativeExpression addOperator
			// multiplicativeExpression
		{
			Object RESULT = null;
		...
		case 75: // relationalExpression ::=
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 74: // relationalExpression ::= additiveExpression
		...
		case 73: // expression ::=
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 72: // expression ::= relationalExpression logicalOperator
			// relationalExpression
		{
			Object RESULT = null;
		...
		case 67: // typeName ::= packageName
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 66: // collectionType ::= collectionTypeIdentifier LEFT_PAR
			// typeName RIGHT_PAR
		{
			Object RESULT = null;
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 65: // ifExp ::= IF oclExpression THEN oclExpression ELSE
			// oclExpression ENDIF
		{
			Object RESULT = null;
		...
		case 62: // associationCallExp ::=
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 61: // associationCallExp ::= simpleName LEFT_BRK arguments
			// RIGHT_BRK
		{
			Object RESULT = null;
		...
		case 36: // loopExp ::= BAR
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 35: // loopExp ::= oclExpression COLLECTIONOPERATION simpleName
			// LEFT_PAR variableDeclaration COMMA variableDeclaration
		{
			Object RESULT = null;
		...
		case 27: // collectionLiteralParts ::=
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 26: // collectionLiteralParts ::= collectionLiteralPart COMMA
			// collectionLiteralParts
		{
			Object RESULT = null;
		...
		case 24: // collectionLiteralExp ::= RIGHT_BRA
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
		case 23: // collectionLiteralExp ::= collectionTypeIdentifier LEFT_BRA
			// collectionLiteralParts
		{
			Object RESULT = null;
